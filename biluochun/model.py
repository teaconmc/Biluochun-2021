...
class Team(db.Model):
    ...
    name = db.Column(db.Unicode(128, collation="utf8mb4"), nullable=False, unique=True)
    mod_name = db.Column(db.Unicode(128, collation="utf8mb4"), nullable=False, unique=True)
    ...
    description = db.Column(db.UnicodeText(collation="utf8mb4"))
